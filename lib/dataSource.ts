...
class ApiDataSource implements IDataSource {
    ...
    getPlaces() {
        return this.json<Place[]>('/places')
    }

    getPlace(id: string) {
        return this.json<Place>(`/places/${id}`)
    }

    getEvents() {
        return this.json<Event[]>('/events')
    }

    getEvent(id: string) {
        return this.json<Event>(`/events/${id}`)
    }
    ...
    getPerformer(id: string) {
        return this.json<Performer>(`/performers/${id}`)
    }
...
export class PlaceRepository {
    ...
    async all() {
        return this.ds.getPlaces()
    }

    async byId(id: string) {
        return this.ds.getPlace(id)
    }
}
...
export class EventRepository {
    ...
    async all() {
        return this.ds.getEvents()
    }

    async byId(id: string) {
        return this.ds.getEvent(id)
    }

    async byPlaceId(placeId: string) {
        return (await this.ds.getEvents()).filter(e => e.placeId === placeId)
    }

    async byPerformerId(performerId: string) {
        return (await this.ds.getEvents()).filter(e => e.performerIds.includes(performerId))
    }
}
...
export class PerformerRepository {
    ...
    async all() {
        return this.ds.getPerformers()
    }

    async byId(id: string) {
        return this.ds.getPerformer(id)
    }
}
