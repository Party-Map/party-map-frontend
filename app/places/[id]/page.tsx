        ...
        <>
            ...
            <main className="pt-24 px-4 pb-24 md:pb-0">
                ...
                <div
                    ...
                    <Image src={place.image} alt={place.name} width={1600} height={900}
                    ...
                    <div className="p-4">
                        ...
                        <div className="mt-2 flex flex-wrap gap-1">
                            {place.tags.map(t => <span key={t}
                                                       className="rounded-full bg-zinc-100/70 dark:bg-zinc-800/60 px-2 py-0.5 text-xs">{t}</span>)}
                        </div>
                    </div>
                </div>
